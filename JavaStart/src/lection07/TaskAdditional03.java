 ...
 * Когда Марья Ивановна забрала у него тетрать, там было 
 * несколько рядов числе. Напишите программу, которая определит 
 * минимальное число которое писав Вовочка. Например:
111111 -> 1
12121212 -> 12
121121121 -> 121*/
